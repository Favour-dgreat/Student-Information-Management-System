 ...
 document.getElementById("select").onclick = function(e) {
     ...
     document.getElementById('upload').onclick = function() {
         ...
         var uploadTask = firebase.storage().ref('Office of the Dean/'+ImgName).put(files[0]); 
     ...
     // submitting the image link to the database
         ...
         function(){
             uploadTask.snapshot.ref.getDownloadURL().then(function(url){
                 ...
                 firebase.database().ref('Office of the Dean/'+ImgName).set({
                     Name: ImgName,
                     Link: ImgUrl
                 });
 ...
 document.getElementById('retrieve').onclick = function() {
     ImgName = document.getElementById('namebox').value;
     firebase.database().ref('Office of the Dean/' +ImgName).on('value', function(snapshot){
